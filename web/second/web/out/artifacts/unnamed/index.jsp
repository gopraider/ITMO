...
<%--            </thead>--%>
<%--            <tbody>--%>
<%--&lt;%&ndash;            <c:forEach var="row" items="${requestScope.results}">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><c:out value="${row.time}"/></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><c:out value="${row.x}"/></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><c:out value="${row.y}"/></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><c:out value="${row.r}"/></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><c:out value="${row.hit ? 'Попадание' : 'Мимо'}"/></td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <td><c:out value="${row.execTimeMs}"/> мс</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </tr>&ndash;%&gt;--%>
